<template>
  ...
  <p>Kort sagt, jag gillar verkligen Vue! Jag tycker att ramverket är logiskt uppbyggt och relativt enkelt att komma
    igång med. Det tog lite tid att förstå koncepten kring props, emits och reaktiv data, men när man väl
    förstod flödet kändes allt mer självklart. Det tog även lite tid att komma in i tänket med komponentbaserad CSS.</p>
  <br>
  <p>Jag uppskattar också strukturen med hur varje komponent har sina egna
